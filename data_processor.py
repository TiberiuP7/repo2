...
class CAENDataProcessor:
    ...
    def initialize_sections(self):
        ...
        self.sections = [
            ...
            "B - INDUSTRIA EXTRACTIVĂ", "C - INDUSTRIA PRELUCRĂTOARE",
            "D - PRODUCȚIA ȘI FURNIZAREA DE ENERGIE",
            "E - DISTRIBUȚIA APEI ȘI SALUBRITATE", "F - CONSTRUCȚII",
            "G - COMERȚ", "H - TRANSPORT ȘI DEPOZITARE",
            ...
            "N - SERVICII ADMINISTRATIVE", "O - ADMINISTRAȚIE PUBLICĂ",
            "P - ÎNVĂȚĂMÂNT", "Q - SĂNĂTATE ȘI ASISTENȚĂ SOCIALĂ",
            "R - ARTĂ, CULTURĂ ȘI RECREERE", "S - ALTE ACTIVITĂȚI DE SERVICII"
        ]
    ...
    def initialize_sample_data(self):
        ...
        self.sample_activities = {
            'A': [{
                ...
                'rev2_code': '0116',
                'rev3_code': '0116',
                'description': 'Cultivarea plantelor pentru fibre textile'
            }, {
                'rev2_code': '0121',
                'rev3_code': '0121',
                'description': 'Cultivarea strugurilor'
            }, {
                'rev2_code':
                '0124',
                'rev3_code':
                '0124',
                'description':
                'Cultivarea fructelor semintoase și sâmburoase'
            }, {
                'rev2_code': '0141',
                'rev3_code': '0141',
                'description': 'Creșterea bovinelor de lapte'
            }, {
                'rev2_code': '0145',
                'rev3_code': '0145',
                'description': 'Creșterea ovinelor și caprinelor'
            }, {
                'rev2_code': '0146',
                'rev3_code': '0146',
                'description': 'Creșterea porcinelor'
            }, {
                'rev2_code': '0147',
                'rev3_code': '0147',
                'description': 'Creșterea păsărilor'
            }],
            'B': [{
                'rev2_code': '0510',
                'rev3_code': '0510',
                'description': 'Extracția cărbunelui superior'
            }, {
                'rev2_code': '0520',
                'rev3_code': '0520',
                'description': 'Extracția cărbunelui inferior'
            }, {
                'rev2_code': '0610',
                'rev3_code': '0610',
                'description': 'Extracția petrolului brut'
            }, {
                'rev2_code': '0620',
                'rev3_code': '0620',
                'description': 'Extracția gazelor naturale'
            }, {
                'rev2_code': '0710',
                'rev3_code': '0710',
                'description': 'Extracția minereurilor feroase'
            }, {
                'rev2_code':
                '0729',
                'rev3_code':
                ...
                '0811',
                'description':
                'Extracția pietrei ornamentale și a pietrei pentru construcții'
            }],
            'C': [{
                'rev2_code': '1011',
                'rev3_code': '1011',
                'description': 'Prelucrarea și conservarea cărnii'
            }, {
                'rev2_code': '1013',
                'rev3_code': '1013',
                'description': 'Fabricarea produselor din carne'
            }, {
                'rev2_code': '1032',
                'rev3_code': '1032',
                'description': 'Fabricarea sucurilor de fructe și legume'
            }, {
                'rev2_code':
                '1051',
                'rev3_code':
                ...
                'rev2_code': '1102',
                'rev3_code': '1102',
                'description': 'Fabricarea vinurilor din struguri'
            }, {
                'rev2_code': '1413',
                'rev3_code': '1413',
                'description': 'Fabricarea altor articole de îmbrăcăminte'
            }, {
                'rev2_code': '1520',
                'rev3_code': '1520',
                'description': 'Fabricarea încălțămintei'
            }],
            'G': [{
                'rev2_code': '4511',
                'rev3_code': '4511',
                'description': 'Comerț cu autoturisme și autovehicule ușoare'
            }, {
                'rev2_code': '4520',
                'rev3_code': '4520',
                'description': 'Întreținerea și repararea autovehiculelor'
            }, {
                'rev2_code':
                '4531',
                'rev3_code':
                ...
                '4776',
                'description':
                'Comerț cu amănuntul al florilor, plantelor și semințelor'
            }],
            'I': [{
                'rev2_code':
                '5510',
                ...
                'rev2_code': '5590',
                'rev3_code': '5590',
                'description': 'Alte servicii de cazare'
            }, {
                'rev2_code': '5610',
                'rev3_code': '5610',
            ...
            'J': [{
                'rev2_code': '5811',
                'rev3_code': '5811',
                'description': 'Activități de editare a cărților'
            }, {
                'rev2_code': '5813',
                'rev3_code': '5813',
                'description': 'Activități de editare a ziarelor'
            }, {
                'rev2_code':
                '5911',
                'rev3_code':
            ...
            'K': [{
                'rev2_code': '6419',
                'rev3_code': '6419',
                'description': 'Alte activități de intermedieri monetare'
            }, {
                'rev2_code': '6492',
                'rev3_code': '6492',
                'description': 'Alte activități de creditare'
            }, {
                'rev2_code': '6511',
                'rev3_code': '6511',
                'description': 'Activități de asigurări de viață'
            }, {
                'rev2_code':
                '6512',
                'rev3_code':
            ...
            'L': [{
                ...
                'rev2_code': '6831',
                'rev3_code': '6831',
                'description': 'Agenții imobiliare'
            }, {
                'rev2_code':
                '6832',
                'rev3_code':
            ...
            'M': [{
                'rev2_code': '6910',
                'rev3_code': '6910',
                'description': 'Activități juridice'
            }, {
                'rev2_code':
                '6920',
                'rev3_code':
                ...
                'rev2_code': '7111',
                'rev3_code': '7111',
                'description': 'Activități de arhitectură'
            }, {
                'rev2_code':
                '7112',
                'rev3_code':
            ...
            'N': [{
                ...
                'rev2_code': '7911',
                'rev3_code': '7911',
                'description': 'Activități ale agențiilor turistice'
            }, {
                'rev2_code':
                '8020',
                'rev3_code':
                ...
                'rev2_code': '8130',
                'rev3_code': '8130',
                'description': 'Activități de întreținere peisagistică'
            }],
            'O': [{
                'rev2_code': '8411',
                'rev3_code': '8411',
                'description': 'Servicii de administrație publică generală'
            }, {
                'rev2_code':
                '8412',
                'rev3_code':
                '8412',
                'description':
                'Reglementarea activităților organismelor care prestează servicii în domeniul îngrijirii sănătății, învățământului, culturii și al altor activități sociale, exclusiv protecția socială'
            }, {
                'rev2_code': '8422',
                'rev3_code': '8422',
                'description': 'Activități de apărare națională'
            }, {
                'rev2_code': '8423',
                'rev3_code': '8423',
                'description': 'Activități de justiție'
            }, {
                'rev2_code':
                '8424',
                'rev3_code':
                '8424',
                'description':
                'Activități de ordine publică și de protecție civilă'
            }],
            'P': [{
                'rev2_code': '8510',
                'rev3_code': '8510',
                ...
                'rev2_code': '8531',
                'rev3_code': '8531',
                'description': 'Învățământ secundar general'
            }, {
                'rev2_code': '8532',
                'rev3_code': '8532',
                'description': 'Învățământ secundar, tehnic sau profesional'
            }, {
                'rev2_code': '8541',
                'rev3_code': '8541',
                'description': 'Învățământ superior non-universitar'
            }, {
                'rev2_code': '8542',
                'rev3_code': '8542',
                'description': 'Învățământ superior universitar'
            }, {
                'rev2_code':
                '8551',
                'rev3_code':
                '8551',
                'description':
                'Învățământ în domeniul sportiv și recreational'
            }],
            'Q': [{
                'rev2_code': '8610',
                'rev3_code': '8610',
                'description': 'Activități de asistență spitalicească'
            }, {
                'rev2_code': '8621',
                'rev3_code': '8621',
                'description': 'Activități de asistență medicală generală'
            }, {
                'rev2_code':
                '8622',
                'rev3_code':
                ...
                'rev2_code': '8623',
                'rev3_code': '8623',
                'description': 'Activități de asistență stomatologică'
            }, {
                'rev2_code':
                '8690',
                'rev3_code':
                ...
                'rev2_code': '8891',
                'rev3_code': '8891',
                'description': 'Activități de îngrijire zilnică pentru copii'
            }],
            'R': [{
                'rev2_code':
                '9001',
                ...
                'rev2_code': '9101',
                'rev3_code': '9101',
                'description': 'Activități ale bibliotecilor și arhivelor'
            }, {
                'rev2_code': '9102',
                'rev3_code': '9102',
                'description': 'Activități ale muzeelor'
            }, {
                'rev2_code':
                '9103',
                'rev3_code':
                ...
                'rev2_code': '9311',
                'rev3_code': '9311',
                'description': 'Activități ale bazelor sportive'
            }, {
                'rev2_code': '9313',
                'rev3_code': '9313',
                'description': 'Activități ale centrelor de fitness'
            }],
            'S': [{
                'rev2_code':
                '9511',
                ...
                'rev2_code': '9512',
                'rev3_code': '9512',
                'description': 'Repararea echipamentelor de comunicații'
            }, {
                'rev2_code':
                '9521',
                'rev3_code':
                ...
                'rev2_code': '9602',
                'rev3_code': '9602',
                'description': 'Coafură și alte activități de înfrumusețare'
            }, {
                'rev2_code': '9603',
                'rev3_code': '9603',
                'description': 'Activități de pompe funebre și similare'
            }]
        }
                ...
                if keyword and results:
                    results = [
                        ...
                        if (keyword.lower() in item['description'].lower()
                            or keyword in item['rev2_code']
                            or keyword in item['rev3_code'])
                    ]
    ...
    @staticmethod
    @st.cache_data
    def _cached_extract_correspondence(_pdf_path: str) -> dict:
        """Cached extraction of correspondence data"""
        correspondence_data = {}
        try:
            with open(_pdf_path, 'rb') as file:
                ...
                for page in pdf_reader.pages:
                    ...
                    for match in matches:
                        ...
                        print(f"Found mapping: {rev2_code} -> {rev3_codes}")
    ...
    def extract_correspondence_data(self, pdf_path):
        """Extract CAEN Rev.2 to Rev.3 correspondence data with caching"""
        if not self._data_initialized:
            self.rev2_to_rev3 = self._cached_extract_correspondence(_pdf_path=pdf_path)
        ...
        with open(pdf_path, 'rb') as file:
            ...
            for page in pdf_reader.pages:
                ...
                for line in lines:
                    ...
                    category_match = re.match(r'^(\d{2})\s+(.+)$',
                                              line.strip())
                    if category_match:
            ...
            for rev3_code in rev3_codes:
                if rev3_code in self.rev3_details:
                    data.append({
                        ...
                        rev3_code,
                        'description':
                        self.rev3_details[rev3_code]['description'],
                        'category':
                        self.rev3_details[rev3_code]['category']
                    })
        ...
        for rev3_code in rev3_codes:
            if rev3_code in self.rev3_details:
                results.append({
                    ...
                    self.rev3_details[rev3_code]['description'],
                    'category':
                    self.rev3_details[rev3_code].get('category', '')
                })
